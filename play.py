...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i>❰Nʀ LᴏᴠᴇX Cʜᴀᴛ❱ 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 𝐔𝐬𝐞𝐫'𝐛𝐨𝐭 𝐈𝐬 𝐍𝐨𝐭 𝐈𝐧 𝐓𝐡𝐢𝐬 𝐂𝐡𝐚𝐭' 𝐀𝐬𝐤 𝐀𝐝𝐦𝐢𝐧 𝐓𝐨 𝐒𝐞𝐧𝐝 /play 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐅𝐨𝐫 𝐅𝐢𝐫𝐬𝐭 𝐓𝐢𝐦𝐞 𝐓𝐨 𝐀𝐝𝐝 𝐈𝐭 😎🤟</i>")
        return
    ...
    if audio:
            ...
            [
                [
                    InlineKeyboardButton(
                        text="❰ 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 🐬 ❱",
                        url="https://t.me/s_4_sahil_hacker")
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                    ...
                    [
                        InlineKeyboardButton(
                            text="Sᴜᴘᴘᴏʀᴛ 🐬",
                            url=f"https://t.me/s_4_sahil_hacker")
                    ]
                ]
            )
        ...
        await lel.edit("🔎 **𝐅𝐢𝐧𝐝𝐢𝐧𝐠 𝐓𝐡𝐞 𝐇𝐢𝐠𝐡 𝐐𝐮𝐚𝐥𝐢𝐭𝐲 🎧 𝐒𝐨𝐧𝐠 🥀 ❰Nʀ LᴏᴠᴇX Bᴏᴛ❱...**")
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png", 
        caption="**🎵 𝐒𝐨𝐧𝐠:** {}\n❰Nʀ LᴏᴠᴇX Bᴏᴛ❱ 𝐒𝐨𝐧𝐠 𝐏𝐨𝐬𝐢𝐭𝐢𝐨𝐧** {}".format(
        title,position
        ),
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="**🎵 𝐒𝐨𝐧𝐠:** {}\n❰Nʀ LᴏᴠᴇX Bᴏᴛ❱ 𝐍𝐨𝐰 𝐏𝐥𝐚𝐲𝐢𝐧𝐠 𝐀𝐭 `{}`...**".format(
